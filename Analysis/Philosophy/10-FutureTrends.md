...
- AI认知模型：→ [../AI/05-Model.md](../AI/05-Model.md)
- 形式化逻辑：→ [../FormalMethods/03-TypeTheory.md](../FormalMethods/03-TypeTheory.md)
- 数学基础：→ [../Mathematics/02-CoreConcepts.md](../Mathematics/02-CoreConcepts.md)
- 软件工程伦理：→ [../SoftwareEngineering/README.md](../SoftwareEngineering/README.md)
